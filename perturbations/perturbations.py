  ...
  """
    ...
    def wrapper(input_tensor, *args, **kwargs):
        ...
        def forward(input_tensor, *args, **kwargs):
            ...
            perturbed_input_shape = tf.concat(
                [[num_samples], input_shape], axis=0
            )
            ...
            perturbed_input = (
                tf.expand_dims(input_tensor, 0) + sigma * additive_noise
            )
            ...
            perturbed_input = tf.reshape(
                perturbed_input, perturbed_input_shape
            )
            # Either
            ...
            perturbed_output = tf.reshape(
                perturbed_output, perturbed_output_shape
            )
            ...
            def grad(dy):
                ...
                flatten = lambda t: tf.reshape(
                    t, (tf.shape(t)[0], tf.shape(t)[1], -1)
                )
